...
import { DeleteHealthProfile, FecthCreateHealthProfile, FecthHealthProfileByStudentId, FecthUpdateHealthProfileNurse } from "@/services/HealthProfileService";
...
export default function UpdateCreateHealthProfile() {
    ...
    const handleInputChange = useCallback((e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        ...
        setFormData(prev => ({ ...prev, [name]: value } as HealthProfileUpdate));
    }, []);
                            ...
                            <div className="flex">
                                ...
                                <div className="ml-3">
                                    <p className="text-sm text-yellow-700">
                                        Học sinh này chưa có hồ sơ sức khỏe. Vui lòng nhập thông tin sức khỏe.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex flex-row gap-2 justify-between">
                            <div className="w-1/2">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <p>Ngày sinh: {new Date(student?.dateOfBirth || "").toLocaleDateString()}</p>
                            ...
                            <div className="w-1/2">
                                <div className="flex flex-col gap-2">
                                    <h2 className="text-2xl font-bold mb-2">Thông tin sức khỏe</h2>
                                    <Label>Mắt</Label>
                                    <Input
                                        type="text"
                                    ...
                                    <textarea
                                        ...
                                        value={formData?.abnormalNote || healthProfile?.abnormalNote || ""}
                                        rows={4}
                                        onChange={handleInputChange}
                                        name="abnormalNote" />
                                    ...
                                    <Input
                                        type="text"
                                        value={formData?.vaccinationHistory || healthProfile?.vaccinationHistory || ""}
                                        onChange={handleInputChange}
